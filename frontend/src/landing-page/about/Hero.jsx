    ...
    return(
        <div className="container">
            <div className="row p-5 mt-5 mb-5">
                <h2 className="fs-3 text-center">We pioneered the discount broking model in India.<br/>Now, we are breaking ground with our technology.</h2>
            </div>
            <div className="row border-top p-5 mt-5" 
                    style={{fontSize:"1.2rem", lineHeight:"1.8", marginBottom:"15px"}}>
